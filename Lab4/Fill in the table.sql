...
-- Обновляем оставшихся администраторов
UPDATE `Train_Station`.`Administration` SET `employee_id` = 1 WHERE `administrator_id` = 1;
UPDATE `Train_Station`.`Administration` SET `employee_id` = 2 WHERE `administrator_id` = 2;
UPDATE `Train_Station`.`Administration` SET `employee_id` = 3 WHERE `administrator_id` = 3;
UPDATE `Train_Station`.`Administration` SET `employee_id` = 4 WHERE `administrator_id` = 4;
UPDATE `Train_Station`.`Administration` SET `employee_id` = 5 WHERE `administrator_id` = 5;
UPDATE `Train_Station`.`Administration` SET `employee_id` = 6 WHERE `administrator_id` = 6;
UPDATE `Train_Station`.`Administration` SET `employee_id` = 7 WHERE `administrator_id` = 7;
